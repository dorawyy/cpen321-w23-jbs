...
const ENDPOINT = "/user_action/checked_profile"
...
// Interface POST https://edumatch.canadacentral.cloudapp.azure.com/user_action/checked_profile
describe("Checked profile", () => {
    ...
    // Expected behavior: tutee’s minRating, locationModeWeight, maxDistance in recommendationWeights are updated correctly
    ...
    test('Should pass when ids, locationMode, recommendationWeights are valid', async() => {
        ...
        expect(res.body).toEqual({ 
            message: "Adjusted weights based on checked profile"
        })
