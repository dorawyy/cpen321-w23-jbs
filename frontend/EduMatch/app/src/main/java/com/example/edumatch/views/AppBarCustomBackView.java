...
public class AppBarCustomBackView extends LinearLayout {
    public AppBarCustomBackView(Context context) {
        super(context);
        init(context);
    }

    public AppBarCustomBackView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AppBarCustomBackView(Context context, AttributeSet attrs, int defStyleAttr) {
