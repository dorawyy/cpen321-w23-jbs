...
const ENDPOINT = "/user_action/contacted_tutor"
...
// Interface POST https://edumatch.canadacentral.cloudapp.azure.com/user_action/contacted_tutor
describe("Contacted tutor", () => {
    ...
    test('Should pass when ids, locationMode, recommendationWeights are valid', async() => {
        ...
        expect(res.body).toEqual({ 
            message: "Adjusted weights based on contacted tutor"
        })
